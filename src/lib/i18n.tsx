...
const en: Dict = {
  ...
  "contact.title": "Tell me about your next move.",
  "contact.body": "Project inquiries, partnerships, or just a hello — I personally read every message.",
...
const ua: Dict = {
  ...
  "hero.intro": "Я — Андрій Куршацов, стратег і продуктовий дизайнер. Партнерюся із засновниками, щоб запускати цифрові продукти, які виглядають невідворотно.",
  ...
  "contact.title": "Розкажіть про ваш наступний крок.",
  "contact.body": "Проєкти, партнерства або просто привіт — я особисто читаю кожне повідомлення.",
  "contact.form.name": "Ваше ім'я",
  "contact.form.email": "Email",
  "contact.form.company": "Компанія або проєкт",
  "contact.form.message": "Розкажіть детальніше",
  "contact.back": "Назад",
  "contact.continue": "Далі",
