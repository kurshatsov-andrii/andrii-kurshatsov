...
const en: Dict = {
  ...
  "process.title": "Transparent process. Clear results.",
  "process.subtitle": "Every project follows a clearly structured process that helps create effective digital solutions for business.",
  "process.step.1.title": "Introduction & brief",
  "process.step.1.desc": "We discuss your goals, tasks and business specifics. Together we shape a shared vision for the project ahead.",
  "process.step.2.title": "Research & strategy",
  "process.step.2.desc": "I analyse the market, competitors and audience to build an effective digital strategy.",
  "process.step.3.title": "Concept & planning",
  "process.step.3.desc": "I create structure, user scenarios and interaction logic for the product.",
  "process.step.4.title": "Design & build",
  "process.step.4.desc": "I craft a modern interface focused on UX, aesthetics and business outcomes.",
  "process.step.5.title": "Testing & launch",
  "process.step.5.desc": "I verify quality, responsiveness and performance before the public launch.",
  "process.step.6.title": "Support & growth",
  "process.step.6.desc": "I help evolve the product after launch and implement new improvements.",
  "process.cta.title": "Ready to discuss your project?",
  "process.cta.body": "Fill out the application form and receive a personal consultation about your product or business.",
  "process.cta.primary": "Start a project",
  "process.cta.telegram": "Message on Telegram",

  "work.kicker": "PORTFOLIO",
  "work.title": "Selected work",
  "work.subtitle": "Selected work at the intersection of art, technology and advertising.",
  "work.archive": "Full archive",
  "work.cat.songs": "AI songs",
  "work.cat.ads": "AI ads",
  "work.cat.clips": "AI clips",
  "work.cat.code": "Vibe coding",
...
const ua: Dict = {
  ...
  "process.title": "Прозорий процес. Зрозумілий результат.",
  "process.subtitle": "Кожен проєкт проходить через чітко структурований процес, який допомагає створювати ефективні цифрові рішення для бізнесу.",
  "process.step.1.title": "Знайомство та бриф",
  "process.step.1.desc": "Обговорюємо цілі, задачі та особливості вашого бізнесу. Формуємо розуміння майбутнього проєкту.",
  "process.step.2.title": "Дослідження та стратегія",
  "process.step.2.desc": "Аналізую ринок, конкурентів та аудиторію для створення ефективної цифрової стратегії.",
  "process.step.3.title": "Концепція та проєктування",
  "process.step.3.desc": "Створюю структуру, користувацькі сценарії та логіку взаємодії з продуктом.",
  "process.step.4.title": "Дизайн та реалізація",
  "process.step.4.desc": "Розробляю сучасний інтерфейс із фокусом на UX, естетику та бізнес-результат.",
  "process.step.5.title": "Тестування та запуск",
  "process.step.5.desc": "Перевіряю якість, адаптивність та продуктивність перед публічним запуском.",
  "process.step.6.title": "Підтримка та розвиток",
  "process.step.6.desc": "Допомагаю розвивати продукт після запуску та впроваджувати нові покращення.",
  "process.cta.title": "Готові обговорити ваш проєкт?",
  "process.cta.body": "Заповніть форму заявки та отримайте персональну консультацію щодо вашого продукту або бізнесу.",
  "process.cta.primary": "Замовити проєкт",
  "process.cta.telegram": "Написати в Telegram",

  "work.kicker": "ПОРТФОЛІО",
  "work.title": "Вибрані роботи",
  "work.subtitle": "Вибрані роботи на перетині мистецтва, технологій і реклами.",
  "work.archive": "Повний архів",
  "work.cat.songs": "ШІ пісні",
  "work.cat.ads": "ШІ реклама",
  "work.cat.clips": "ШІ кліпи",
  "work.cat.code": "Вайб кодинг",
