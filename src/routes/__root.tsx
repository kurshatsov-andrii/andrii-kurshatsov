...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A premium personal brand website showcasing services, portfolio, and generating leads for entrepreneurs." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A premium personal brand website showcasing services, portfolio, and generating leads for entrepreneurs." },
